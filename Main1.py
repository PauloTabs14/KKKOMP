...
class HomePageUI(QWidget):
    ...
    def homepage_setup_ui(self):
        ...
        add_product_btn = QPushButton("Sell / Add Product")
...
class ItemDetailsUI(QWidget):
    def __init__(self, homepage_window, image_path, name, price, stocks, rating, description, seller):
        super().__init__()
...
class CheckoutUI(QWidget):
    ...
    # If you have more fields to validate, add them here

    # If all validations pass, show confirmation
        self.show_payment_confirmation(method)
    # (Optional) Clear cart, go back to homepage, etc.
