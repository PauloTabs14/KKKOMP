...
class LoginUI(QWidget):
    ...
    def setup_ui(self):
        ...
        #Google and Facebook logo pero hindi pa nafifix
        ...
        #Wrapper - All Structures deployed
        wrapper = QVBoxLayout()
        wrapper.addStretch()
    ...
    #Password Input Function at username
...
class HomePageUI(QWidget):
    ...
    def homepage_setup_ui(self):
        ...
        products_grid = [
            ...
            {"image": "clothes.png", "name": "Tupad Clothes", "price": "$150", "stocks": "30", "rating": "⭐⭐⭐",
                "description": "Bibile ka neto? Matuto kang TUMUPAD sa usapan!"}
        ]
        ...
        for pos, product in zip(positions, products_grid):
            ...
            btn.clicked.connect(lambda _, p=product: self.open_item_details(
                p["image"], p["name"], p["price"], p["stocks"], p["rating"], p["description"]
            ))
    ...
    def open_item_details(self, image_path, name, price, stocks, rating, description):
        self.item_details_window = ItemDetailsUI(self, image_path, name, price, stocks, rating, description)
...
class ItemDetailsUI(QWidget):
    def __init__(self, homepage_window, image_path, name, price, stocks, rating, description):
        super().__init__()
...
class InventoryCartUI(QWidget):
    ...
    def get_cart_item(self):
         return [
            ("sneakers.png", "Shoes", 70, "Shoe Marketplace"),
            ("laptop.png", "Laptop", 600, "Laptop Marketplace"),
            ("phone.png", "Phone", 300, "Apple Marketplace")
    ]

    #Proceeding to Checkout
    def open_checkout(self):
        self.open_checkout_window = CheckoutUI(self) #dito ko cinonect ung inventorycart at checkoutui
...
class CheckoutUI(QWidget):
    ...
    def checkout_setup_ui(self):
        ...
        self.subtotal_value = 100  # Replace 100 with your actual subtotal calculation if needed
    ...
    def place_order(self):
        QMessageBox.information(self, "Order Placed", "Your Order has been Submitted!")
...
class NotificationUI(QWidget):
    ...
    def notification_setup_ui(self):
        ...
        notification_data = [
            "Order #1432: Your order has been shipped!",
            "Flash Deal: Up to 50% OFF on selected items!",
            "Reminder: New arrivals now available in Shoe Marketplace.",
        ]
